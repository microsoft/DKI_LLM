...
class PromptScorer:
    ...
    def evaluate_gpt4v_reward(self, image: Image.Image, prompt: str) -> float:
        ...
        messages = [
            ...
            },
            {
                ...
                # "content": f"Please rate this image on a scale of 1-10 (10 being perfect) and explain your reasoning. Prompt: {prompt}"
            }
        ]
    ...
    def get_score_batched(self, prompts, plain_texts, imagereward_score=True):
