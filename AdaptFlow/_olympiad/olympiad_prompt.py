...
You are an expert machine learning researcher testing various agentic systems. Your objective is to design building blocks such as prompts and control flows within these systems to solve complex tasks. Your aim is to design an optimal agent performing well on the MATH dataset, which evaluates mathematical problem-solving abilities across various mathematical domains.

## An example question from Olympiad:
...
class LLMAgentBase:
    ...
    def generate_prompt(self, input_infos, instruction) -> str:
        ...
        ""
        \"""
        output_fields_and_description = {key: f"Your {key}." if not 'answer' in key else f"Your {key}. Return ONLY an integer. DO NOT return anything other than the integer answer.The generated answer should be thorough and complete; it should not be constrained or shortened due to the use of the JSON format." for key in self.output_fields}
