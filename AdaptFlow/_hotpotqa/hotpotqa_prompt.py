...
QD = {"thought": "Similar to Quality-Diversity methods, let LLM generate multiple diverse interesting answers could help. By encouraging the model to explore different reasoning paths, we can increase the chances of finding the best answer.",
...
You are an expert machine learning researcher testing various agentic systems. Your objective is to design building blocks such as prompts and control flows within these systems to solve complex tasks. Your aim is to design an optimal agent performing well on the HotpotQA dataset, which evaluates problem-solving abilities across various domains.

## An example question from HotpotQA:

**instruction (Not Given)**: Solve the following problem and provide an answer.

**question**: Lost Someone was written by James Brown and an American R&B/soul singer who began his career in 1952 as a member of what gospel group?\nNote that you are given context: {context information}


**Answer (Not Given)**: Gospel Starlighters
...
The fitness value is defined as the F1 score on a validation question set. Your goal is to maximize this fitness. You should use your own judgment to decide whether to optimize on the latest architecture, as its performance may not necessarily be better.
