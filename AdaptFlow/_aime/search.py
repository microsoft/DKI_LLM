...
from aime_prompt import get_init_archive, get_prompt, get_meta_prompt, get_adaptation_prompt, get_reflexion_prompt, get_fail_reflexion_prompt

from utils import load_all_examples, is_correct, random_id, bootstrap_confidence_interval, extract_median
...
def evaluate_forward_fn_key(args, forward_str, key, file_dir):
    ...
    for idx, res in enumerate(results):
        try:
            ...
            correct = is_correct(correct_answer, extracted_answer)
        except Exception as e:
            acc_list.append(0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--expr_name', type=str, default="aime_gpt4omini_results")
    ...
    parser.add_argument('--train_dir_path', type=str, default="dataset/aime/validate")
    parser.add_argument('--test_dir_path', type=str, default="dataset/aime/test")
    # test_math_486
